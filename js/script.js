...
function generatePlayGround(){
  ...
  for (let i = 1; i <= cellNumbers; i++){
    ...
    square.addEventListener('click',function(event){
      console.log('square cliccato/innerText:',event.target.innerText);
  ...
  function generateBombs(){
    ...
    //se il numero estratto(la bomba)bomb non è gia 'incluso' allora lo pusho nell'array bombs finche avrò 16 numeri   
